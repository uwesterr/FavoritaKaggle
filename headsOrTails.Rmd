...
```{r split=FALSE, fig.align = 'default', warning = FALSE, fig.cap ="Fig. 13", fig.height=4, out.width="100%"}
plot_item(1503844)
```
...
```{r split=FALSE, fig.align = 'default', warning = FALSE, fig.cap ="Fig. 15", fig.height=3.5, out.width="100%"}
train %>%
  filter(unit_sales > 0) %>%
  group_by(item_nbr) %>%
  summarise(sales = sum(unit_sales)) %>%
...
```{r message = FALSE, split=FALSE, fig.align = 'default', warning = FALSE, fig.cap ="Fig. 19", out.width="100%"}
foo %>%
...
```{r message = FALSE, split=FALSE, fig.align = 'default', warning = FALSE, fig.cap ="Fig. 20", out.width="100%"}
foo <- train %>%
  group_by(date) %>%
  summarise(sales = sum(unit_sales))
...
```{r message = FALSE, split=FALSE, fig.align = 'default', warning = FALSE, fig.cap ="Fig. 21", fig.height=3.5, out.width="100%"}
bar <- foo %>%
...
```{r message = FALSE, split=FALSE, fig.align = 'default', warning = FALSE, fig.cap ="Fig. 22", out.width="100%"}
foo <- train %>%
...
```{r message = FALSE, split=FALSE, fig.align = 'default', warning = FALSE, fig.cap ="Fig. 23", out.width="100%"}
p1 <- bar %>%
